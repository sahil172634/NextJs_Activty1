...
export const DESCRIPTIONS: string[] = [
  `<p>In partnership with resi.uatz.view.com.au,<a> Settle Easy</a> is currently offering new customers a $220 conveyancing voucher on their trusted <a> online conveyancing services </a> and a free contract review. You&apos;ll only pay $880 incl. GST plus disbursements on a standard conveyancing transaction.Redeem today and use within 12 months.`,
...
export const FAQs: IAccordian[] = [
  {
    ...
    subTitle: `<p>Conveyancing is the process of moving the legal ownership of property or land from one person or entity to another.</p>`,
  },
  {
    title: 'What is a conveyancer?',
    subTitle: `<p>A conveyancer is a property transfer specialist. They prepare the legal documents that form part of real estate transactions such as the purchase and sale of properties, settlements and title transfers.</p>`,
  },
  {
    title: 'How much does it cost?',
    subTitle: ` <p>Whether you are buying or selling property, our services are set at a fixed price.</p>
      <p>The only cost variable relates to disbursements.</p>
      <p>We don't want you to be worried about the word 'disbursements' - it's just an everyday legal term used to describe out of pocket expenses and all property transactions in Australia will incur some of these.</p>
      <p>We'll always be upfront about your conveyancing costs, so as soon as you ask us to help you, we can provide you with an estimate of how much your disbursements are likely to be.</p>
      <p>These out of pocket costs all depend on the type of property you have bought or sold and where that property is located.</p>`,
  },
  {
    title: 'What types of conveyancing does Settle Easy do?',
    subTitle: `<p>Our experienced team specialise in all types of conveyancing including:</p><ul><li>residential properties.</li><li>large scale off the plan property developments</li><li>retirement village residences</li>
      <li>commercial properties</li><li>properties within trust structures</li><li>properties for self-managed superannuation funds (SMSFs).</li></ul>`,
  },
  {
    title: `How will I know what's happening?`,
    subTitle: `<p>At Settle Easy, we are committed to keeping you updated every step of the way.</p>
